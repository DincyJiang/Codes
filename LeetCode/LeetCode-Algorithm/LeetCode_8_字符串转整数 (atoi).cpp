...
// 假设我们的环境只能存储 32 位有符号整数，其数值范围是 [−231,  231 − 1]。如果数值超过可表示的范围，则返回  INT_MAX (2^31 − 1) 或 INT_MIN (−2^31) 。
    ...
    int myAtoi(string str) {
        ...
        while (i < n && str[i] >= '0' && str[i] <= '9') {
            if (base > INT32_MAX / 10 || 
                ...
                // INT32_MAX (2147483647) or INT32_MIN (-2147483648) 
